                                    ...
                                    @case('rating')
                                        ...
                                        <div class="flex gap-3 justify-center py-4">
                                            @for($i = 1; $i <= $maxStars; $i++)
                                                ...
                                                >
                                                    <svg class="w-12 h-12 transition-colors {{ $i <= $currentRating ? 'text-amber-400 fill-amber-400 drop-shadow-[0_0_8px_rgba(251,191,36,0.4)]' : 'text-gray-200' }}" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="0.5">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    @if($currentStep < $totalBlocks - 1)
                                        ...
                                        >
                                            ...
                                            <span wire:loading.inline-flex wire:target="nextBlock" class="items-center justify-center gap-2">
